            ...
            <div class="page-breadcrumb border-bottom">
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8 col-xs-12 d-flex justify-content-start justify-content-md-end align-self-center">
                        ...
                        <router-link to='/category' class="btn btn-info text-white d-none d-md-block">View Category List</router-link>
                    </div>
                </div>
            </div>
            ...
            <div class="page-content container-fluid">
                <div class="row justify-content-center">
                    <div class="col-6">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Edit category from here</h4>
                                </h6>
                            </div>
                            <hr>
...
<script>
    export default {
        ...
        methods: {
            updateCategory() {
                this.axios
                    .patch(`http://127.0.0.1:8000/api/category/${this.$route.params.id}`, this.category)
                    .then((res) => {
                        this.$router.back();
                        Toast.fire({
                          icon: 'success',
